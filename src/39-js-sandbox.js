...
(function () {
  ...
  const WORKER_SOURCE = [
    ...
    "  var PARAMS = 'console, self, postMessage, onmessage, globalThis, importScripts, close, setTimeout, setInterval, clearTimeout, clearInterval, queueMicrotask, describe, it, test, expect, beforeEach, afterEach';",
    ...
    "    var g = self, keys = ['console', 'setTimeout', 'setInterval', 'clearTimeout', 'clearInterval', 'queueMicrotask', 'describe', 'it', 'test', 'expect', 'beforeEach', 'afterEach'];",
    "    var vals = { console: sandboxConsole, setTimeout: wrapTimeout, setInterval: wrapInterval, clearTimeout: wrapClearTimeout, clearInterval: wrapClearInterval, queueMicrotask: nQueueMicro, describe: describeFn, it: itFn, test: itFn, expect: makeExpect, beforeEach: beforeEachFn, afterEach: afterEachFn };",
    "    var saved = {}, had = {};",
    ...
    "      return factory(sandboxConsole, undefined, undefined, undefined, undefined, undefined, undefined, wrapTimeout, wrapInterval, wrapClearTimeout, wrapClearInterval, nQueueMicro, describeFn, itFn, itFn, makeExpect, beforeEachFn, afterEachFn);",
    "    }).then(function () { return runTestsIfAny(runId); }, function (err) { reportError(err); })",
    "      .then(function () { return drainUntilIdle(); })",
    "      .then(function () { finish(); }, function () { finish(); });",
    "  }",
