...
| Runner JS/TS | `39-js-protocol.js`, `39-js-runner.js`, `39-js-sandbox.js`, `72-js-workspace.js` | Protocolo, coordenador de sessões, sandbox isolada e painel de interface para executar JavaScript do aluno |
...
- `72-js-workspace.js` (`LX.JSWorkspace`) é a camada de interface: abre um arquivo `.js` do VFS, dispara a execução e desenha os eventos no painel "JS" do laboratório. Só orquestra e renderiza; não executa código do aluno.
