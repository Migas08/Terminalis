...
for(const test of ['smoke','docker','git','estrutura','vocabulario','git-vocabulary','solutions','workspace','cloud','mutation','local-store','javascript-runtime','javascript-security'])run(['test/'+test+'.js']);
